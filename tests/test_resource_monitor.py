...
def test_start_monitor(resource_monitor):
    ...
    with patch("threading.Thread") as mock_thread:
        ...
        mock_thread.assert_called_once_with(
            target=resource_monitor._monitor_loop, daemon=True
        )
...
def test_can_start_new_process_under_limit(
    mock_virtual_memory, resource_monitor
):
...
@patch("psutil.virtual_memory")
def test_can_start_new_process_over_limit(
    mock_virtual_memory, resource_monitor
):
...
@patch("time.sleep")
@patch("psutil.virtual_memory")
def test_monitor_loop_memory_threshold(
    mock_virtual_memory, mock_sleep, resource_monitor
):
